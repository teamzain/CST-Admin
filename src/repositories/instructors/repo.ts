...
function transformInstructor(instructor: any): Instructor {
    ...
    const allLicenses =
        instructor.licenses || instructor.instructorLicenses || [];
    ...
    const stateInfo =
        ...
        instructor.state ||
        (instructor.state_id ? { id: instructor.state_id } : undefined);
    ...
    const transformed: Instructor = {
        ...
        assigned_courses: allLicenses.flatMap(
            (l: any) => l.courses || l.assigned_courses || []
        ),
...
export class InstructorsRepository {
    ...
    static async getAllInstructors(
        ...
        try {
            ...
            console.error(
                '[InstructorsRepository] Error fetching instructors:',
                error
            );
    ...
    static async getInstructorById(id: number): Promise<Instructor> {
        try {
            ...
            console.error(
                '[InstructorsRepository] Error fetching instructor:',
                error
            );
    ...
    static async createInstructor(
        ...
        try {
            ...
            console.error(
                '[InstructorsRepository] Error creating instructor:',
                error
            );
    ...
    static async deleteInstructor(id: number): Promise<void> {
        try {
            ...
            console.error(
                '[InstructorsRepository] Error deleting instructor:',
                error
            );
            const errorMessage = getErrorMessage(
                error,
