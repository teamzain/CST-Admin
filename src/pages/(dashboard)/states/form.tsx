...
export default function StateFormPage() {
    ...
    const updateMutation = useMutation({
        mutationFn: (data: CreateStateInput) =>
            StatesRepository.update(Number(id), data),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['states'] });
            ...
            StatesRepository.getById(Number(id)).then((existingState) => {
                if (existingState) {
                    setFormData({
                        ...
                        unarmed_passing_score:
                            existingState.unarmed_passing_score,
                        ...
                        is_seat_time_enabled:
                            existingState.is_seat_time_enabled,
